        ...
        <div class="pay-success">
            <div class="success-order-info">
                ...
                <div class="success-info">
                    <div class="info">
                        <img :src="$store.state.port.staticPath + '/img/home/cashier/for_icon.png'" alt="">
                        <div class="tips">
                    ...
                    <div class="cashier-price">
                        ...
                        <p class="info-detail" @click="show = !show">
                            <span>订单详情</span>
                            <img :class="show ? 'is-active' : ''" :src="$store.state.port.staticPath + '/img/home/cashier/green_down_icon.png'" alt="">
                        </p>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        handleJumpOrder(title) {
            ...
            this.$bus.$emit('setMyOrder', title)
        },
        // 继续购物
        handleJumpPrint() {
    ...
    beforeDestroy() {
        this.$bus.$emit('setMyOrder', this.title)
    },
    mounted() {
